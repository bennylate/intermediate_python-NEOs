...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        for approach in approaches:
            if self._approaches.get(approach._designation, None):
                self._approaches[approach._designation].append(approach)
            else:
                self._approaches[approach._designation] = [approach]
            for a in self._approaches[approach._designation]:
        ...
        if filters:
            for approach in self._approaches:
                if all(map(lambda f: f(approach), filters)):
                    yield approach
        # returns all the close approaches if no filter entered
        else: 
            for approach in self._approaches:
                yield approach
